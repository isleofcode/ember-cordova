...
var addAllowNav      = require('../utils/add-allow-navigation');
var chalk            = require('chalk');
var logger           = require('../utils/logger');
var removeAllowNav   = require('../utils/remove-allow-navigation');
...
module.exports = Task.extend({
  ...
  run: function(options) {
    this.cleanupOnExit();
    var localhost = 'http://localhost:' + options.port;
    addAllowNav(this.project, localhost);
