...
var ServeTask       = require('ember-cli/lib/tasks/serve');
...
module.exports = {
  ...
  run: function(options) {
    ...
    //TODO FIX ME, remove the goop, safely get port
    var serveOpts = options;
    serveOpts.baseURL = this.project.config().baseURL;
    serveOpts.liveReloadPort = 49152;
    serveOpts.project = this.project;
    serve = new ServeTask({
      ui: this.ui,
